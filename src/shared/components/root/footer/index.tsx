...
export default function Footer() {
  ...
  const SocialMedia = () => (
    <Stack flexDirection="row" gap={1} justifyContent="center" width="100%">
      <Tooltip title="Meu GitHub">
        <IconButton
          color="primary"
          href="https://github.com/ArthurFCouto"
          size="medium"
          target="_blank"
        >
          <GitHub />
      ...
      <Tooltip title="Meu linkedIn">
        <IconButton
          color="primary"
          href="https://www.linkedin.com/in/arthur-couto-b8181743/"
          size="medium"
          target="_blank"
        >
          <LinkedIn />
      ...
      <Tooltip title="Meu Whatsapp">
        <IconButton
          color="primary"
          href="https://wa.me/5538999414205?text=Ol%C3%A1!%20Vim%20pelo%20Notinha!"
          size="medium"
          target="_blank"
        >
          <WhatsApp />
