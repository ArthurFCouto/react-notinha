...
export default function QrReader({
    ...
    if (videoElement?.current && !scanner.current) {
      ...
      scanner.current
        ...
        .catch((error) => {
          ...
          onError(
            'A câmera está bloqueada ou inacessível. Por favor, altere as permissões da câmera no seu navegador e recarregue a página.'
          );
        });
    }
  ...
  return (
    <Box height={height / 2} position="relative" paddingTop={2}>
      <Box
        borderRadius={1}
        component="video"
        ref={videoElement}
