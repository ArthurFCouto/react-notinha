...
export default function Home() {
  ...
  const clearFilter = () => {
    ...
    if (filterRef.current !== null) filterRef.current.value = '';
  };
    ...
    <Box display="flex" flexDirection="column" height="100%">
      ...
      >
        ...
        <Paper
          ...
          width="100%"
        >
          <IconButton color="secondary" onClick={() => setOpenQR(true)}>
            {sendingUrl ? (
        ...
        {(loading || isPending) && <CardItemsLoading amount={10} />}
      ...
      <ModalQrReader
        ...
        getCode={(code) =>
          SendUrl(code, sendingUrl, setSendingUrl, dispatchAlert)
        }
        onError={(message) => {
